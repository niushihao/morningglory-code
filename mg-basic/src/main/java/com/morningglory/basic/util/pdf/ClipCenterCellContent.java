...
public class ClipCenterCellContent {
    ...
    public static final String DEST = "/Users/nsh/tool/pdf_example/clip_center_cell_content.pdf";
    ...
    public class CenterContent implements PdfPCellEvent {
        ...
        public void cellLayout(PdfPCell cell, Rectangle position,
            ...
            try {
                ...
                ct.go(true);
                System.out.println("getYLine ="+ct.getYLine());
        ...
        for (int r = 'A'; r <= 'Z'; r++) {
            for (int c = 1; c <= 5; c++) {
                ...
                if (r == 'D' && c == 2) {
                    ...
                    //cell.setCellEvent(new CenterContent(new Paragraph("哈哈")));
                }
                else {
