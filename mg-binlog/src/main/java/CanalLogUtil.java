 ...
 * @Desc:
 */
public class CanalLogUtil {
    protected final static Logger log             = LoggerFactory.getLogger(CanalLogUtil.class);
    ...
    protected static String buildPositionForDump(CanalEntry.Entry entry) {
