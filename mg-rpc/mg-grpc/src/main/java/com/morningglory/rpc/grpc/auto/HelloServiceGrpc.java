...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.morningglory.rpc.grpc.auto.HelloRequest,
      com.morningglory.rpc.grpc.auto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.morningglory.rpc.grpc.auto.HelloRequest.class,
      responseType = com.morningglory.rpc.grpc.auto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.morningglory.rpc.grpc.auto.HelloRequest,
      com.morningglory.rpc.grpc.auto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.morningglory.rpc.grpc.auto.HelloRequest, com.morningglory.rpc.grpc.auto.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.morningglory.rpc.grpc.auto.HelloRequest, com.morningglory.rpc.grpc.auto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.morningglory.rpc.grpc.auto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.morningglory.rpc.grpc.auto.HelloResponse.getDefaultInstance()))
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.morningglory.rpc.grpc.auto.HelloRequest,
                com.morningglory.rpc.grpc.auto.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.morningglory.rpc.grpc.auto.HelloResponse sayHello(com.morningglory.rpc.grpc.auto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.morningglory.rpc.grpc.auto.HelloResponse> sayHello(
        com.morningglory.rpc.grpc.auto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.morningglory.rpc.grpc.auto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.morningglory.rpc.grpc.auto.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.morningglory.rpc.grpc.auto.Hello.getDescriptor();
    }
